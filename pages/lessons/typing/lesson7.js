...
const lessonText = "Learning a new skill can be challenging, but every effort you make adds to your growth. Mistakes are not failures; they are lessons that guide you toward improvement. Stay patient, stay committed, and the results will follow.";

const Lesson7 = () => {  // Ensure the component name matches the export statement
  ...
  const handleNextLesson = () => {
    router.push('/lessons/typing/lesson8');
  };
  const handlePreviousLesson = () => { router.push('/lessons/typing/lesson6'); };
  ...
  return (
    <div className={styles.container}>
      <div className={styles.typingContainer}>
        <h1>Typing Lesson 7</h1> {/* Ensure the title matches the lesson */}
        <p>{lessonText}</p>
        <textarea
...
export default Lesson7; // Ensure this matches the component name
