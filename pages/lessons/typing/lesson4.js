...
const Lesson4 = () => {  // Make sure this matches the export statement
  ...
  const handleNextLesson = () => {
    router.push('/lessons/typing/lesson5');
  };
  const handlePreviousLesson = () => { router.push('/lessons/typing/lesson3'); };
