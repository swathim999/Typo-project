...
const lessonText = "Success comes to those who work hard and stay dedicated to their goals. Each small step forward brings you closer to achieving your dreams. Believe in yourself, and let perseverance guide your journey.";

const Lesson6 = () => {  // Ensure the component name matches the export statement
  ...
  const handleNextLesson = () => {
    router.push('/lessons/typing/lesson7');
  };
  const handlePreviousLesson = () => { router.push('/lessons/typing/lesson5'); };
  ...
  return (
    <div className={styles.container}>
      <div className={styles.typingContainer}>
        <h1>Typing Lesson 6</h1> {/* Ensure the title matches the lesson */}
        <p>{lessonText}</p>
        <textarea
...
export default Lesson6; // Ensure this matches the component name
