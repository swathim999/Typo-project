...
const lessonText = "Every day is a new opportunity to learn, grow, and improve yourself. Small consistent efforts can lead to remarkable achievements over time. Embrace the journey and celebrate every milestone along the way.";

const Lesson8 = () => {  // Ensure the component name matches the export statement
  ...
  const handleNextLesson = () => {
    router.push('/lessons/typing/lesson9');
  };
  const handlePreviousLesson = () => { router.push('/lessons/typing/lesson7'); };
  ...
  return (
    <div className={styles.container}>
      <div className={styles.typingContainer}>
        <h1>Typing Lesson 8</h1> {/* Ensure the title matches the lesson */}
        <p>{lessonText}</p>
        <textarea
...
export default Lesson8; // Ensure this matches the component name
