...
const lessonText = "Practice makes perfect. Consistency is key to improvement.";
...
const Lesson2 = () => {
  ...
  const handleNextLesson = () => {
    router.push('/lessons/typing/lesson3');
  };

  const handlePreviousLesson = () => { router.push('/lessons/typing/lesson1'); };
