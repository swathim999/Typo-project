...
const lessonText = "Learning to type helps you finish your work faster and easier. It’s fun to practice typing games and improve your speed. Keep practicing, and soon you’ll type like a pro.";
...
const Lesson3 = () => {
  ...
  const handleNextLesson = () => {
    router.push('/lessons/typing/lesson4');
  };
  const handlePreviousLesson = () => { router.push('/lessons/typing/lesson2'); };
