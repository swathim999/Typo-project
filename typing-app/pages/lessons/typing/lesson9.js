...
const Lesson9 = () => {  // Ensure the component name matches the export statement
  ...
  const handleNextLesson = () => {
    router.push('/lessons/typing/lesson10');
  };
  const handlePreviousLesson = () => { router.push('/lessons/typing/lesson8'); };
  ...
  return (
    <div className={styles.container}>
      <div className={styles.typingContainer}>
        <h1>Typing Lesson 9</h1> {/* Ensure the title matches the lesson */}
        <p>{lessonText}</p>
        <textarea
...
export default Lesson9; // Ensure this matches the component name
